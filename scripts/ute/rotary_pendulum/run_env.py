...
Usage:
    ./isaaclab.sh -p ./source/isaaclab_assets/isaaclab_assets/rotary_pendulum/run_rl_robot_env.py --device cpu
"""
...
from isaaclab_assets.rotary_pendulum.navigation.balance import RotaryPendulumBalanceEnvCfg


def main():
    # Setup environment
    env_cfg = RotaryPendulumBalanceEnvCfg()
