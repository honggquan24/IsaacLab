...
Usage:
    # Basic usage
    ./isaaclab.sh -p scripts/ute/evobot/keyboard_tests/test_policy_keyboard_full_copy.py \
...
# ./isaaclab.sh -p scripts/ute/evobot/keyboard_tests/test_policy_keyboard_full.py         --load_run
# 2026-01-20_01-01-48         --checkpoint model_1335.pt


# ./isaaclab.sh -p scripts/ute/evobot/keyboard_tests/test_policy_keyboard_full_copy.py         --load_run
# 2026-01-21_08-24-47         --checkpoint model_1410.pt --rendering quality
    ...
    while simulation_app.is_running():
        with torch.inference_mode():
            ...
            if count % 50 == 0:
                ...
                print(
                    f"\r[CMD] Vel: v_x={v_x:+.2f} ω_z={omega_z:+.2f} | Arm: yaw={arm_yaw:+.2f} | "
