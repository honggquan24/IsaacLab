...
def test_pid_decomposition():
    ...
    roll_control = kp_roll_true * roll_error + ki_roll_true * roll_integral + kd_roll_true * roll_vel

    pitch_control = kp_pitch_true * pitch_error + ki_pitch_true * pitch_integral + kd_pitch_true * pitch_vel
