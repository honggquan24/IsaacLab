...
Usage:
    ...
    python scripts/ute/evobot/plotting/plot_velocity_tracking.py \
        logs/evobot/rl_velocity_tracking_20260116_123456.csv

    python scripts/ute/evobot/plotting/plot_velocity_tracking.py \
        logs/evobot/rl_velocity_tracking_20260116_123456.csv --output my_plot.png

    python scripts/ute/evobot/plotting/plot_velocity_tracking.py \
        logs/evobot/rl_velocity_tracking_20260116_123456.csv --no-show
"""
