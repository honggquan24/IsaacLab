...
để viết phân tích.
    ...
    python scripts/ute/report/report_figs.py
"""
...
LOGDIR = "source/isaaclab_assets/isaaclab_assets/wheeled_biped/logs/legged_v5_wheel_mimic"
OUTDIR = "source/isaaclab_assets/isaaclab_assets/wheeled_biped/NCKH/figure/results"
MAX_STEP = 600
...
def plot_overview():
    ...
    r = series("Train/mean_reward")
    el = series("Train/mean_episode_length")
    ...
    fig.tight_layout()
    fig.savefig(os.path.join(OUTDIR, "01_train_overview.png"), dpi=150)
    plt.close()
    print("  saved 01_train_overview.png")


plot_overview()
plot(
    "02_task_rewards.png",
    "Phan thuong nhiem vu",
    "Episode reward",
    [
        "Episode_Reward/track_height",
        "Episode_Reward/track_lin_vel_y_exp",
        "Episode_Reward/track_lin_vel_x_exp",
        "Episode_Reward/track_ang_vel_z_exp",
    ],
)
plot(
    "03_penalty_rewards.png",
    "Phan thuong phat",
    "Episode reward",
    [
        "Episode_Reward/lateral_tilt",
        "Episode_Reward/com_wheel_plane",
        "Episode_Reward/hip_symmetry",
        "Episode_Reward/stand_still",
        "Episode_Reward/action_rate",
        "Episode_Reward/fore_aft_tilt",
        "Episode_Reward/velocity_overshoot",
        "Episode_Reward/leg_joint_acc",
        "Episode_Reward/termination_penalty",
    ],
    logy=True,
)
plot(
    "04_tracking_metrics.png",
    "Chi so bam lenh",
    "Error",
    [
        ...
        "Metrics/height_command/orientation_error",
    ],
)
plot(
    "05_terminations.png",
    "Ti le ket thuc episode",
    "Ti le",
    [
        "Episode_Termination/time_out",
        "Episode_Termination/bad_orientation",
        "Episode_Termination/base_height",
        "Episode_Termination/illegal_contact_hip",
        "Episode_Termination/illegal_contact_knee",
        "Episode_Termination/joint_vel_limit",
    ],
)
plot("06_loss.png", "PPO losses", "Loss", ["Loss/value_function", "Loss/surrogate", "Loss/entropy"])
