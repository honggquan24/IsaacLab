...
"""Lái robot V5 wheel bằng bàn phím (pygame GUI) — ghi đè velocity_command lên policy đã train.

Điều khiển (focus vào cửa sổ pygame "V5 Teleop"):
...
parser.add_argument("--task", type=str, default="Isaac-Legged-V5-Wheel", help="Name of the task.")
parser.add_argument(
...
from isaaclab.utils.math import euler_xyz_from_quat, quat_mul, quat_conjugate, wrap_to_pi
...
import isaaclab_assets  # noqa: F401  ← register custom tasks (legged_v5, ...)
...
class TeleopPanel:
    ...
    def __init__(self, vy_max: float, wz_max: float):
        ...
        pygame.display.set_caption("V5 Teleop + Debug")
