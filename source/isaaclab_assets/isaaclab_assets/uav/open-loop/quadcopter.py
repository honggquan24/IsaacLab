...
def main():
    ...
    robot_cfg = robot_cfg.replace(init_state=robot_cfg.init_state.replace(pos=(0.0, 0.0, 0.0)))
    ...
    while simulation_app.is_running():
        ...
        if count % 20000 == 0 and count > 0:
            ...
            # reset command
            print(">>>>>>>> Reset!")
        # apply action to the robot (gradually increase thrust)
        thrust_scale = min(1.0, sim_time / 5.0)  # tăng từ 0 lên 1x trong 5 giây
        
        # forces[..., 0] = Fx = 0
        # forces[..., 1] = Fy = 0
        # forces[..., 2] = Fz = thrust/4 (chia đều cho 4 props)
        ...
        # Tích lũy góc quay cánh quạt và ghi mỗi bước
