...
@configclass
class LeggedV3WheelNavPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    """PPO runner config for legged_v3 hierarchical navigation (high-level policy)."""

    num_steps_per_env = 32
    max_iterations = 3000
    save_interval = 100
    experiment_name = "legged_v3_navigation"
