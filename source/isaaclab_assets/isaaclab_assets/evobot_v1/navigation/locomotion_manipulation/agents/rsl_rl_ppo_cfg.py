"""PPO configuration for Evobot V1 locomotion-manipulation task."""
...
@configclass
class EvobotLocomotionManipulationPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    max_iterations = 1000
    save_interval = 20
    experiment_name = "evobot_v1_locomotion_manipulation"
