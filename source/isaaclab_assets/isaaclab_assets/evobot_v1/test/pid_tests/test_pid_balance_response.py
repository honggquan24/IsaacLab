...
Usage:
    ...
    ./isaaclab.sh -p source/isaaclab_assets/isaaclab_assets/evobot_v1/balance/test_pid_balance_response.py
...
def main():
    ...
    print(f"{'Time':>8s} {'Roll':>10s} {'Pitch':>10s} {'Yaw':>10s} {'R_Error':>10s} {'P_Error':>10s} {'WheelL':>10s} {'WheelR':>10s} {'Arm':>10s}")
    print("-" * 108)
            ...
            with torch.inference_mode():
                ...
                if step_count % args_cli.log_interval == 0:
                    ...
                    if step_count % (args_cli.log_interval * 10) == 0:
                        print(f"{elapsed_time:8.2f} {roll:10.4f} {pitch:10.4f} {yaw:10.4f} {roll_error:10.4f} {pitch_error:10.4f} {wheel_left:10.4f} {wheel_right:10.4f} {arm_effort:10.4f}")
