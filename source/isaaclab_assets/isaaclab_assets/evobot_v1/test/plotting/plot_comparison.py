...
Usage:
    ...
    python source/isaaclab_assets/isaaclab_assets/evobot_v1/test/plot_comparison.py

    # Or specify files manually
    python source/isaaclab_assets/isaaclab_assets/evobot_v1/test/plot_comparison.py \
        source/isaaclab_assets/isaaclab_assets/evobot_v1/test/logs/demo_rl_tracking_20260122_073817.csv \
        source/isaaclab_assets/isaaclab_assets/evobot_v1/test/logs/demo_pid_tracking_20260122_073817.csv
...
parser.add_argument("rl_csv", type=str, nargs="?", default=None, help="Path to RL tracking CSV file (optional, auto-detects if not provided)")
parser.add_argument("pid_csv", type=str, nargs="?", default=None, help="Path to PID tracking CSV file (optional, auto-detects if not provided)")
...
if args.rl_csv is None or args.pid_csv is None:
    ...
    print(f"[INFO] Auto-detected files:")
