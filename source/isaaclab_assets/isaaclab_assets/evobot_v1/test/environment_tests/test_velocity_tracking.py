        ...
        while simulation_app.is_running() and elapsed_time < total_duration:
            with torch.inference_mode():
                ...
                if args_cli.use_pid:
                    ...
                    wheel_indices = [robot.joint_names.index("left_wheel_joint"), robot.joint_names.index("right_wheel_joint")]
                    ...
                    obs, reward, terminated, truncated, info = env.step(torch.zeros(args_cli.num_envs, env.action_space.shape[0], device=args_cli.device))
                ...
                if step_count % args_cli.log_interval == 0:
                    ...
                    if step_count % 50 == 0:
                        ...
                        print(
                            f"{elapsed_time:8.2f} {vx_cmd_val:10.3f} {vx_actual_val:10.3f} {wz_cmd_val:10.3f} {wz_actual_val:10.3f} {vx_err:10.3f} {wz_err:10.3f}"
                        )
