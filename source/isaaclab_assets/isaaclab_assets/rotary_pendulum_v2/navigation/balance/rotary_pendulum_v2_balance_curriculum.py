...
from ...rotary_pendulum_v2_cfg import ROTARY_PENDULUM_V2_CFG
...
class RotaryPendulumSceneConfig(InteractiveSceneCfg):
    ...
    robot: Articulation = ROTARY_PENDULUM_V2_CFG.replace(  # type: ignore
...
@configclass
class RotaryPendulumV2BalanceStage1EnvCfg(ManagerBasedRLEnvCfg):
...
@configclass
class RotaryPendulumV2BalanceStage2EnvCfg(ManagerBasedRLEnvCfg):
