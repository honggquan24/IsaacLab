...
"""Navigation environment using pre-trained balance policy for cart_v1.
...
from ...cart_v1_env_cfg import CartbalanceEnvCfg
...
LOW_LEVEL_ENV_CFG = CartbalanceEnvCfg()
...
class LowLevelObservationsCfg(ObsGroup):
    ...
    Based on cart_v1_env_cfg.py ObservationsCfg.PolicyCfg (without obs_pos_w).
    """
...
class ActionsCfg:
    ...
    pre_trained_policy_action: PreTrainedBalancePolicyActionCfg = PreTrainedBalancePolicyActionCfg(
        ...
        #   --task Isaac-Cartbalance-V1-Run --num_envs 1 'agent.load_run=<run_name>' 'agent.load_checkpoint="model_.pt"'
...
@configclass
class CartV1NavigationPretrainedEnvCfg(ManagerBasedRLEnvCfg):
...
@configclass
class CartV1NavigationPretrainedEnvCfg_PLAY(CartV1NavigationPretrainedEnvCfg):
