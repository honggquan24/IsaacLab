...
from isaaclab_assets.balancecar_v1 import CART_BALANCE_CFG
...
class ImuSensorSceneCfg(InteractiveSceneCfg):
    ...
    prim_path="/World/envs/env_.*/Robot/balance_robot/balance_robot/balance_body",
        ...
        pos=(0.0, 0.0, 0.15),   # nâng lên 15cm theo trục Z local
        rot=(0.0, 0.0, 0.0, 1.0),    # không xoay
    ),
    update_period=0.0,
    debug_vis=True,
    )
...
#./isaaclab.sh -p ./source/isaaclab_assets/isaaclab_assets/balancecar_v1/sensor/test_imu.py --device cpu