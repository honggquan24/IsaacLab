...
# --num_envs 10 \
# 'agent.load_run=complete5' \
# 'agent.load_checkpoint="model_399.pt"' --device cpu
...
# ==============================================================================
# Train navigation:
# ./isaaclab.sh -p sc./isaaclab.sh -p scripts/reinforcement_learning/rsl_rl/play.py \
# --task Isaac-Cartbalance-V1-Run \
# --num_envs 10 \
# 'agent.load_run=complete5' \
# 'agent.load_checkpoint="model_399.pt"' --device cpuripts/reinforcement_learning/rsl_rl/train.py \
