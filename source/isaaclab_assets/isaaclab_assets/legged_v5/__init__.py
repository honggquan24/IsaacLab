...
gym.register(
    id="Isaac-Legged-V5-Wheel-PIANN",    # bánh = PI-ANN (mạng xuất Kp/Ki/Kd, PID quy ra lệnh bánh)
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.locomotion.legged_v5_wheel_env_cfg_piann:LeggedV5WheelPIANNEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:LeggedV5WheelPIANNPPORunnerCfg",
    },
)
...
gym.register(
    id="Isaac-Legged-V5-Obstacle-Nav",   # tầng cao + LiDAR: né vật cản trên terrain sinh thủ tục (train song song)
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.navigation.legged_v5_obstacle_nav_env_cfg:LeggedV5ObstacleNavEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:LeggedV5ObstacleNavPPORunnerCfg",
    },
)
