...
Chạy:
    python source/isaaclab_assets/isaaclab_assets/legged_v5/tools/report_cut_epoch.py \
        --src logs/rsl_rl/legged_v5_wheel_mimic/2026-06-15_19-24-41 \
        --dst source/isaaclab_assets/isaaclab_assets/legged_v5/logs/legged_v5_wheel_mimic_2000ep \
        --max_iter 2000
"""
import argparse
import glob
