...
USD_PATH = _arg[0] if _arg else os.path.join(os.path.dirname(os.path.dirname(__file__)), "usd_file", "robot_v5.usd")
OUT_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "joints_topology.txt")
