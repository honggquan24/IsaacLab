...
from .balance_cfg import EVOBOT_BALANCE_CFG
...
class EvobotSceneConfig(InteractiveSceneCfg):
    ...
    robot: Articulation = EVOBOT_BALANCE_CFG.replace(  # type: ignore
...
class TerminationsCfg:
    ...
    contact_arm = TerminationTermCfg(
        ...
        params={"threshold": 30.0, "sensor_cfg": SceneEntityCfg(name="contact_forces_arm_link")},
    )


@configclass
class EvobotBalanceEnvCfg(ManagerBasedRLEnvCfg):
