    ...
    velocity_command = commands.UniformVelocityCommandCfg(
        ...
        ranges=commands.UniformVelocityCommandCfg.Ranges(
            ...
            lin_vel_y=(
                -0.5,
                0.5,
                # tiến/lùi ±0.5 m/s (FIX: giá trị trước là ±5.0 — sai 10× so với comment, khiến lệnh bất khả thi → robot
                # bỏ bám tốc, chỉ đứng cân bằng)
            ),
...
class TerminationsCfg:
    ...
    bad_orientation = TerminationTermCfg(
        ...
        params={
            # ~63° — đủ sớm hơn π/2 nhưng CHỪA biên lean fore-aft khi tăng tốc (0.8 quá chặt, cắt luôn maneuver hợp
            # lệ → bỏ bám tốc)
            "limit_angle": 1.1,
            "asset_cfg": SceneEntityCfg(name="robot"),
        },
...
@configclass
class WheeledBipedWheelEnvCfg(ManagerBasedRLEnvCfg):
