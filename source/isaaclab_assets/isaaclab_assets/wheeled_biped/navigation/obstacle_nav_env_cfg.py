...
Play:
    ./isaaclab.sh -p scripts/reinforcement_learning/rsl_rl/play.py \\
        --task Isaac-Wheeled-Biped-Obstacle-Nav --num_envs 16
"""
...
from .navigation_env_cfg import NavSceneCfg, WheeledBipedNavigationEnvCfg
from .warehouse_nav_env_cfg import (
...
@configclass
class WheeledBipedObstacleNavEnvCfg(WheeledBipedNavigationEnvCfg):
