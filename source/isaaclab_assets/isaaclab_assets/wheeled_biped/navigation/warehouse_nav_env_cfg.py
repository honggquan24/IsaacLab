...
Kế thừa WheeledBipedNavigationEnvCfg (nav mặt phẳng) và bổ sung:
...
Play (1 robot, xem LiDAR):
    ./isaaclab.sh -p scripts/reinforcement_learning/rsl_rl/play.py \\
        --task Isaac-Wheeled-Biped-Warehouse-Nav --num_envs 1
"""
...
from .navigation_env_cfg import (
    ...
    NavSceneCfg,
    NavTermCfg,
    WheeledBipedNavigationEnvCfg,
)

WAREHOUSE_USD = (
    f"{ISAAC_NUCLEUS_DIR}/Environments/Simple_Warehouse/warehouse_multiple_shelves.usd"  # nhiều kệ/đồ hơn warehouse.usd
)
...
@configclass
class WheeledBipedWarehouseNavEnvCfg(WheeledBipedNavigationEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.events.reset_position.params["pose_range"] = {
            "x": (-1.0, 1.0),
            "y": (-1.0, 1.0),  # KHÔNG yaw (yaw làm robot lật do base xoay 90°X)
        }
