...
from .velocity_command import NormalVelocityCommand, UniformVelocityCommand, UniformVelocity2DCommand
...
@configclass
class UniformVelocity2DCommandCfg(CommandTermCfg):
    """Configuration for the uniform velocity 2D command generator."""

    class_type: type = UniformVelocity2DCommand
